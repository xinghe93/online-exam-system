                ...
                <form action="${pageContext.request.contextPath}/questionManage" method="post" id="questionForm">
                    ...
                    <div class="options-grid">
                        <div class="option-input">
                            ...
                            <input type="text" name="optionA" placeholder="选项 A" required>
                        </div>
                        <div class="option-input">
                            <div class="option-letter">B</div>
                            <input type="text" name="optionB" placeholder="选项 B" required>
                        </div>
                        <div class="option-input">
                            <div class="option-letter">C</div>
                            <input type="text" name="optionC" placeholder="选项 C" required>
                        </div>
                        <div class="option-input">
                            <div class="option-letter">D</div>
                            <input type="text" name="optionD" placeholder="选项 D" required>
                        </div>
                    </div>
                    ...
                    <div class="answer-select">
                        <label class="answer-option" onclick="selectAnswer('A')">
                            <input type="radio" name="answer" value="A" id="ansA">
                            <span>A</span>
                        </label>
                        <label class="answer-option" onclick="selectAnswer('B')">
                            <input type="radio" name="answer" value="B" id="ansB">
                            <span>B</span>
                        </label>
                        <label class="answer-option" onclick="selectAnswer('C')">
                            <input type="radio" name="answer" value="C" id="ansC">
                            <span>C</span>
                        </label>
                        <label class="answer-option" onclick="selectAnswer('D')">
                            <input type="radio" name="answer" value="D" id="ansD">
                            <span>D</span>
                        </label>
                    </div>
                    ...
                    <div class="btn-row">
                        <button type="submit" class="btn btn-submit">保存试题</button>
